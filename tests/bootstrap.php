 ...
 * @return array
 */
function stream_filter_active_plugins_for_phpunit( $active_plugins ) {
...
tests_add_filter( 'site_option_active_sitewide_plugins', 'stream_filter_active_plugins_for_phpunit' );
tests_add_filter( 'option_active_plugins', 'stream_filter_active_plugins_for_phpunit' );
